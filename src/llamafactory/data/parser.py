...
class DatasetAttr:
    ...
    # basic configs
    load_from: Literal["hf_hub", "ms_hub", "om_hub", "script", "file", "cloud_file", "dynamic_file"]
    dataset_name: str
...
def get_dataset_list(dataset_names: list[str] | None, dataset_dir: str | dict) -> list["DatasetAttr"]:
    ...
    for name in dataset_names:
        ...
        elif "dynamic_file_name" in dataset_info[name]:
            dataset_attr = DatasetAttr("dynamic_file", dataset_name=dataset_info[name]["dynamic_file_name"])
        else:
